...
Compared to HydroMT, {{cookiecutter.project_name}} has additional dependencies, namely:
...
```
  $ python make_env.py full -n {{cookiecutter.project_slug}}
```

When the script is finished, a file called environment.yml will be created which you can pass to mamba as demonstrated in the sections below. This will include all mandatory and optional dependencies of {{cookiecutter.project_name}}.
